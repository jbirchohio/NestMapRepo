...
import { BarChart3, Users, MapPin, DollarSign, TrendingUp, Calendar, Sparkles, Building2, FileText, Settings, Plus, ArrowUpRight, Clock, Target } from "lucide-react";
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="relative overflow-hidden bg-gradient-to-br from-electric-500 via-electric-600 to-electric-700 text-white">
        ...
        <div className="relative container mx-auto px-6 py-16">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="flex gap-3">
          ...
          <CardContent className="p-4 pt-0">
            <div className="space-y-3">
              {(displayStats?.upcomingDeadlines || []).map((deadline: any, index: number) => (<div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                  ...
                  <Badge variant={deadline.priority === 'high' ? 'destructive' :
