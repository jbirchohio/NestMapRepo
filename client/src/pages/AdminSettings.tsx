                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="maxUsers"
                      type="number"
                      value={settings?.general.maxUsersPerOrganization || 0}
                      onChange={(e) => handleSettingUpdate('general', 'maxUsersPerOrganization', parseInt(e.target.value))}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleSettingUpdate('general', 'emailVerificationRequired', checked)}
                    />
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleSettingUpdate('security', 'passwordExpiryDays', parseInt(e.target.value))}
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      checked={settings?.security.enforcePasswordComplexity || false}
                      onCheckedChange={(checked) => handleSettingUpdate('security', 'enforcePasswordComplexity', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleSettingUpdate('security', 'requireTwoFactor', checked)}
                    />
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      checked={settings?.features.enableAIFeatures || false}
                      onCheckedChange={(checked) => handleSettingUpdate('features', 'enableAIFeatures', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      checked={settings?.features.enableFlightBooking || false}
                      onCheckedChange={(checked) => handleSettingUpdate('features', 'enableFlightBooking', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      checked={settings?.features.enableCorporateCards || false}
                      onCheckedChange={(checked) => handleSettingUpdate('features', 'enableCorporateCards', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      checked={settings?.features.enableWhiteLabel || false}
                      onCheckedChange={(checked) => handleSettingUpdate('features', 'enableWhiteLabel', checked)}
                    />
                  </div>
                </div>
              </CardContent>
