...
export default function FlightSearch() {
  ...
  const searchFlightsMutation = useMutation({
    mutationFn: (params: FlightSearchParams) => 
      apiRequest('POST', '/api/flights/search', params),
    onSuccess: (data) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-electric-50 to-electric-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-6">
      <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Select
                      value={searchParams.passengers.adults.toString()}
                      onValueChange={(value) => 
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value: any) => 
                      setSearchParams(prev => ({ ...prev, cabin_class: value }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
        ...
        {/* Search Results */}
        {searchFlightsMutation.data?.success && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Card>
              <CardHeader>
                ...
                {searchFlightsMutation.data.source === 'duffel_api' && (
              ...
              <CardContent>
                <div className="space-y-4">
                  {searchFlightsMutation.data.data.map((flight: FlightOffer, index: number) => (
                    <motion.div
                      key={flight.id}
                      ...
                      {flight.slices.map((slice, sliceIndex) => (
                        <div key={sliceIndex} className="mb-4 last:mb-0">
                          ...
                          <div className="flex items-center gap-4 mt-2 text-xs text-muted-foreground">
                            {flight.passengers[0]?.baggage.map((bag, bagIndex) => (
                              <div key={bagIndex} className="flex items-center gap-1">
