    ...
    return (<div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          {whiteLabelConfig?.isWhiteLabelActive && (<Badge className="bg-green-100 text-green-800">
              White Label Active
            </Badge>)}
        </div>
      </div>

      {!hasWhiteLabelAccess && (<Alert>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="branding" className="space-y-6">
          <Card>
            ...
            <CardContent>
              {whiteLabelConfig?.isWhiteLabelActive ? (<div className="p-6 border rounded-lg bg-gradient-to-r from-blue-50 to-electric-50">
                  <div className="text-2xl font-bold mb-2" style={{ color: whiteLabelConfig.config.primaryColor }}>
                    {whiteLabelConfig.config.companyName}
                  </div>
                  <p className="text-gray-600">Your branded travel management platform</p>
                  <div className="flex space-x-2 mt-4">
                    <div className="w-6 h-6 rounded" style={{ backgroundColor: whiteLabelConfig.config.primaryColor }}/>
                    <div className="w-6 h-6 rounded" style={{ backgroundColor: whiteLabelConfig.config.secondaryColor }}/>
                    <div className="w-6 h-6 rounded" style={{ backgroundColor: whiteLabelConfig.config.accentColor }}/>
                  </div>
                </div>) : (<div className="p-6 border rounded-lg bg-gray-50">
