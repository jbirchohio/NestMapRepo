      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-start">
          ...
          <div className="flex items-center gap-2">
            ...
            {permission === 'edit' && (<Button onClick={() => window.location.href = `/trip/${(trip as any).id}`} size="sm">
        ...
        <Card>
          ...
          <CardContent>
            {(trip as any).activities?.length > 0 ? (<div className="space-y-3">
              ...
              </div>) : (<p className="text-muted-foreground">No activities yet</p>)}
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            {(trip as any).todos?.length > 0 ? (<div className="space-y-2">
              ...
              </div>) : (<p className="text-muted-foreground">No tasks yet</p>)}
          </CardContent>
        </Card>
      </div>
    </div>);
