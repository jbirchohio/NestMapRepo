            ...
            return (<Card key={request.id} className={`${isOverdue ? 'border-red-500' : ''}`}>
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {request.escalationLevel > 0 && (<Badge variant="outline">Escalated</Badge>)}
                      </div>
                    </div>
                  </CardHeader>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {request.proposedData.totalAmount && (<div className="flex items-center gap-2 text-sm">
                      ...
                      {request.dueDate && (<div className="flex items-center gap-2 text-sm">
                      ...
                      {request.businessJustification && (<div className="mt-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      ...
                      {request.reason && (<div className="mt-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                          <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-1">
                            Request Reason
                          </h4>
                          <p className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <div className="flex gap-2 pt-4">
                        <Button onClick={() => handleApprove(request)} disabled={approveMutation.isPending} className="flex-1">
                          <CheckCircle className="h-4 w-4 mr-2"/>
                          Approve
                        </Button>
                        <Button variant="outline" onClick={() => setSelectedRequest(request)} disabled={approveMutation.isPending} className="flex-1">
      ...
      <Dialog open={!!selectedRequest} onOpenChange={() => setSelectedRequest(null)}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleReject} disabled={!rejectionReason.trim() || approveMutation.isPending} variant="destructive">
              Reject Request
            </Button>
          </DialogFooter>
        </DialogContent>
