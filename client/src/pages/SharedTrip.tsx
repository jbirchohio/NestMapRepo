      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            {permission === 'edit' && (<Button onClick={handleEditRedirect} className="ml-auto">
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            {trip.activities?.length > 0 ? (<div className="space-y-4">
                {trip.activities.map((activity: SharedActivityType, index: number) => (<div key={activity.id} className="flex gap-4 p-4 rounded-lg border">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-muted-foreground mt-1">
                        {activity.time && (<span className="mr-4">🕒 {activity.time}</span>)}
              ...
              </div>) : (<p className="text-muted-foreground text-center py-8">No activities planned yet</p>)}
          </CardContent>
        </Card>

        {/* Notes */}
        {trip.notes?.length > 0 && (<Card className="mb-6">
            <CardHeader>
        ...
        <div className="mt-8 text-center">
          <p className="text-muted-foreground mb-4">
            Like this trip? Create your own with NestMap!
          </p>
