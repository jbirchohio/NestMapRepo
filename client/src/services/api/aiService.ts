...
class AIService {
  ...
  public async chat(
    ...
    return apiClient.post<AIChatResponse, { messages: AIChatMessage[]; sessionId?: string }>(
      `${this.basePath}/chat`,
      { messages, sessionId },
      config
    );
  ...
  public async findLocation(
    ...
    return apiClient.post<AILocationSuggestion, any>(
  ...
  public async generateItinerary(
    ...
    return apiClient.post<{ itinerary: string; suggestions: AISuggestion[] }, any>(
  ...
  public async getActivitySuggestions(
    ...
    return apiClient.post<AISuggestion[], any>(
  ...
  public async analyzeImage(
    ...
    config?: RequestConfig
  ): Promise<{ description: string; tags: string[]; metadata: Record<string, any> }> {
    ...
    return apiClient.post<{ description: string; tags: string[]; metadata: Record<string, any> }, FormData>(
