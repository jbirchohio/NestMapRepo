...
class TripService {
  ...
  public async getDashboardTrips(params?: {
    ...
    return getApiClient().get<TripCardDTO[]>(`${this.basePath}/dashboard`, { params });
  }
  ...
  public async getCorporateTrips(params?: Omit<GetTripsParams, 'organizationId'>): Promise<TripsResponse> {
    return getApiClient().get<TripsResponse>('/corporate/trips', { params });
  }
}
