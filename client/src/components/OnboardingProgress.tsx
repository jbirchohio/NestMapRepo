...
export default function OnboardingProgress({ onTaskClick, className }: OnboardingProgressProps) {
  ...
  return (
    <Card className={`bg-white/80 dark:bg-navy-800/80 backdrop-blur-sm border border-electric-300/20 ${className}`}>
      <CardHeader>
      ...
      <CardContent className="space-y-3">
        {tasks.map((task, index) => (
          ...
          >
            <div className={`flex items-center gap-3 p-3 rounded-lg border transition-all hover:bg-navy-50/50 dark:hover:bg-navy-700/50 ${
              task.completed 
              ...
              {!task.completed && (
                <Button
                  ...
                  className="shrink-0 border-electric-300 text-electric-600 hover:bg-electric-50"
                >
                  {task.action}
        ...
        {completedTasks === totalTasks && (
          <motion.div
            ...
            className="mt-4 p-4 bg-gradient-to-r from-electric-50 to-electric-100 dark:from-electric-900/20 dark:to-electric-800/20 rounded-lg text-center"
          >
