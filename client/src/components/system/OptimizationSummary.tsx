...
export function OptimizationSummary({ optimizations, totalFilesOptimized, performanceImprovements }: OptimizationSummaryProps) {
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            return (<div key={opt.name} className="border rounded-lg p-4">
                  ...
                  {opt.modulesCreated.length > 0 && (<div>
                      <p className="text-sm text-muted-foreground mb-2">Modules Created:</p>
                      <div className="flex flex-wrap gap-1">
                        {opt.modulesCreated.map((module, index) => (<Badge key={index} variant="outline" className="text-xs">
                            {module}
                          </Badge>))}
                      </div>
                    </div>)}
