...
import { Zap, AlertTriangle, CheckCircle, Clock, Route, Bell, Calendar, MapPin, TrendingUp, Settings, RefreshCw, Target } from 'lucide-react';
...
export default function SmartOptimizer({ tripId, activities, onActivitiesUpdate }: SmartOptimizerProps) {
    ...
    return (<div className="space-y-6">
        ...
        <CardContent>
          ...
          <div className="mt-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Switch checked={isAutoOptimizeEnabled} onCheckedChange={setIsAutoOptimizeEnabled}/>
              <span className="text-sm font-medium">Auto-optimize schedule</span>
            </div>
            
            <Button onClick={() => refetchOptimization()} variant="outline" size="sm" className="flex items-center gap-2">
      ...
      {/* Critical Alerts */}
      {hasConflicts && showConflicts && (<Alert className="border-destructive/20 bg-destructive/10">
          ...
          <AlertDescription className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button size="sm" variant="outline" onClick={() => setShowConflicts(false)}>
                Dismiss
              </Button>
            </div>
          </AlertDescription>
        ...
        <CardContent className="pt-6">
          <Tabs value={selectedTab} onValueChange={setSelectedTab}>
            ...
            <TabsContent value="settings" className="space-y-4">
              <SettingsTab isAutoOptimizeEnabled={isAutoOptimizeEnabled} onAutoOptimizeChange={setIsAutoOptimizeEnabled}/>
            </TabsContent>
          </Tabs>
        </CardContent>
      </Card>
...
function OptimizationTab({ optimization, onApplyOptimization, isApplying }: OptimizationTabProps) {
    ...
    return (<div className="space-y-4">
      ...
      <div className="flex justify-center">
        <Button onClick={onApplyOptimization} disabled={isApplying} className="flex items-center gap-2">
        ...
        {conflicts.map((conflict: any, index: number) => (<Alert key={index} className={getSeverityColor(conflict.severity)}>
            ...
            <AlertDescription>
              <div className="flex justify-between items-start">
                ...
                {conflict.autoFixAvailable && (<Button size="sm" variant="outline" onClick={() => onAutoFix([conflict.id])} disabled={isFixing}>
                    Fix
                  </Button>)}
              </div>
            </AlertDescription>
...
function RemindersTab({ reminders }: RemindersTabProps) {
    ...
    return (<div className="space-y-4">
      ...
      {reminders.length === 0 && (<div className="text-center py-8 text-gray-500">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch checked={isAutoOptimizeEnabled} onCheckedChange={onAutoOptimizeChange}/>
          </div>
