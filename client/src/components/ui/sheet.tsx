...
>(({ className, ...props }, ref) => {
  ...
  return <SheetPrimitive.Overlay {...(overlayProps as any)} />;
})
...
>(({ side = "right", className, children, ...props }, ref) => {
  ...
  return (
    <SheetPortal>
      <SheetOverlay />
      <SheetPrimitive.Content {...(contentProps as any)}>
        {children}
        <SheetPrimitive.Close {...({className: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary", children: [
          <X key="icon" className="h-4 w-4" />,
          <span key="text" className="sr-only">Close</span>
        ]} as any)} />
...
>(({ className, ...props }, ref) => {
  ...
  return <SheetPrimitive.Title {...(titleProps as any)} />;
})
...
>(({ className, ...props }, ref) => {
  ...
  return <SheetPrimitive.Description {...(descriptionProps as any)} />;
})
