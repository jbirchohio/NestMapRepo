    ...
    return (<Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[80vh]">
        ...
        <div className="space-y-4">
          {!optimizationResult ? (<div className="text-center py-8">
              <div className="mb-4">
              ...
              <Button onClick={handleOptimize} disabled={optimizeItinerary.isPending || activities.length === 0} className="bg-electric-600 hover:bg-electric-700">
              ...
              {activities.length === 0 && (<p className="text-sm text-muted-foreground mt-2">
              ...
              <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      {optimizationResult.recommendations.map((rec, index) => (<div key={index} className="flex items-start gap-2">
                ...
                return (<div key={optimization.id} className="border rounded-lg p-4 space-y-3">
                            <div className="flex items-start justify-between">
                              ...
                              {(hasTimeChange || hasDayChange) && (<Badge variant="secondary" className="bg-electric-100 text-electric-700">
                                  Changes suggested
                                </Badge>)}
                            </div>
