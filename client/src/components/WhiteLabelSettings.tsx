...
import { Palette, Globe, Image, Settings, Eye, Save, Upload, Paintbrush, Type, Link, Smartphone } from 'lucide-react';
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button onClick={form.handleSubmit(onSubmit)} disabled={isSaving} className="flex items-center gap-2">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    {form.formState.errors.companyName && (<p className="text-sm text-destructive">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="tagline" {...form.register("tagline")} placeholder="Your company tagline"/>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    {currentValues.companyLogo && (<div className="flex items-center gap-2">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="footerText" {...form.register("footerText")} placeholder="Copyright and footer information" rows={2}/>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="border rounded-lg p-4 bg-white dark:bg-slate-900">
                  <div className="flex items-center gap-3 pb-3 border-b">
                    {currentValues.companyLogo ? (<img src={currentValues.companyLogo} alt="Company Logo" className="h-8 w-8 rounded object-cover"/>) : (<div className="h-8 w-8 rounded flex items-center justify-center text-white text-sm font-bold" style={{ backgroundColor: currentValues.primaryColor }}>
                    ...
                    <div className="flex flex-col">
                      ...
                      {currentValues.tagline && (<span className="text-sm text-muted-foreground">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <Input type="color" id="primaryColor" {...form.register("primaryColor")} className="w-12 h-10 p-1"/>
                      <Input {...form.register("primaryColor")} placeholder="#2563eb" className="flex-1"/>
                    </div>
                    {form.formState.errors.primaryColor && (<p className="text-sm text-destructive">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <Input type="color" id="secondaryColor" {...form.register("secondaryColor")} className="w-12 h-10 p-1"/>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <Input type="color" id="accentColor" {...form.register("accentColor")} className="w-12 h-10 p-1"/>
                      <Input {...form.register("accentColor")} placeholder="#10b981" className="flex-1"/>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 border rounded-lg">
                  ...
                  <div className="flex gap-3">
                    <div className="h-16 w-24 rounded flex items-center justify-center text-white text-xs font-medium" style={{ backgroundColor: currentValues.primaryColor }}>
                      Primary
                    </div>
                    <div className="h-16 w-24 rounded flex items-center justify-center text-white text-xs font-medium" style={{ backgroundColor: currentValues.secondaryColor }}>
                      Secondary
                    </div>
                    <div className="h-16 w-24 rounded flex items-center justify-center text-white text-xs font-medium" style={{ backgroundColor: currentValues.accentColor }}>
                      Accent
                    </div>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="border rounded-lg bg-white dark:bg-slate-900">
                  {/* Mock Navigation Bar */}
                  <div className="flex items-center justify-between p-3 rounded-t-lg text-white" style={{ backgroundColor: currentValues.primaryColor }}>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="p-4 border-x">
                    <div className="flex items-center gap-2 mb-3">
                      <div className="h-3 w-3 rounded-full" style={{ backgroundColor: currentValues.accentColor }}></div>
                    ...
                    <div className="mt-3 flex gap-2">
                      <div className="px-3 py-1 rounded text-xs text-white" style={{ backgroundColor: currentValues.primaryColor }}>
                        Primary Button
                      </div>
                      <div className="px-3 py-1 rounded text-xs border" style={{
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="customDomain" {...form.register("customDomain")} placeholder="travel.yourcompany.com"/>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="supportEmail" type="email" {...form.register("supportEmail")} placeholder="support@yourcompany.com"/>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="helpUrl">Help/Documentation URL</Label>
                    <Input id="helpUrl" {...form.register("helpUrl")} placeholder="https://help.yourcompany.com"/>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="companyWebsite">Company Website</Label>
                    <Input id="companyWebsite" {...form.register("companyWebsite")} placeholder="https://yourcompany.com"/>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="privacyPolicyUrl">Privacy Policy URL</Label>
                    <Input id="privacyPolicyUrl" {...form.register("privacyPolicyUrl")} placeholder="https://yourcompany.com/privacy"/>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="termsOfServiceUrl">Terms of Service URL</Label>
                    <Input id="termsOfServiceUrl" {...form.register("termsOfServiceUrl")} placeholder="https://yourcompany.com/terms"/>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch id="enableGuestMode" checked={form.watch("enableGuestMode")} onCheckedChange={(checked) => form.setValue("enableGuestMode", checked)}/>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch id="enablePublicSignup" checked={form.watch("enablePublicSignup")} onCheckedChange={(checked) => form.setValue("enablePublicSignup", checked)}/>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch id="enableSocialLogin" checked={form.watch("enableSocialLogin")} onCheckedChange={(checked) => form.setValue("enableSocialLogin", checked)}/>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch id="enableMobileApp" checked={form.watch("enableMobileApp")} onCheckedChange={(checked) => form.setValue("enableMobileApp", checked)}/>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="border rounded-lg overflow-hidden bg-white dark:bg-slate-900">
                  ...
                  <div className="border-b bg-white dark:bg-slate-900 px-4 py-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="h-8 w-8 rounded flex items-center justify-center text-white text-sm font-bold" style={{ backgroundColor: currentValues.primaryColor }}>
                          {currentValues.companyName.charAt(0)}
                        </div>
                        <div className="flex flex-col">
                          <span className="font-bold text-lg text-slate-900 dark:text-slate-100">
                          ...
                          {currentValues.tagline && (<span className="text-xs text-muted-foreground -mt-1">
                              {currentValues.tagline}
                            </span>)}
                        </div>
                      </div>
                  ...
                  <div className="border-b bg-slate-50 dark:bg-slate-800 px-4 py-2">
                    <div className="flex items-center gap-6 text-sm">
                      <div className="px-3 py-1 rounded text-white font-medium" style={{ backgroundColor: currentValues.primaryColor }}>
                        Travel Console
                      </div>
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between p-3 border rounded-lg">
                          <div className="flex items-center gap-3">
                            <div className="h-2 w-2 rounded-full" style={{ backgroundColor: currentValues.accentColor }}/>
                        ...
                        <div className="flex items-center justify-between p-3 border rounded-lg">
                          <div className="flex items-center gap-3">
                            <div className="h-2 w-2 rounded-full" style={{ backgroundColor: currentValues.primaryColor }}/>
                    ...
                    <div className="flex justify-center pt-2">
                      <Button className="px-4 py-2 rounded text-primary-foreground text-sm font-medium bg-primary hover:bg-primary/90">
