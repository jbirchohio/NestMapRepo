  ...
  return (
    <>
      ...
      <div className="block lg:hidden">
        ...
        {/* Mobile Sidebar */}
        <div className={cn(
          "fixed top-0 left-0 h-screen w-64 bg-navy-800 dark:bg-navy-900 border-r border-electric-200/30 dark:border-electric-700/30 flex flex-col z-50 transition-transform duration-300",
      ...
      <div className="hidden lg:block">
        <div className="h-screen w-64 bg-navy-800 dark:bg-navy-900 border-r border-electric-200/30 dark:border-electric-700/30 flex flex-col">
          {/* Header */}
          <div className="p-6 border-b border-electric-200/30 dark:border-electric-700/30">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-gradient-to-br from-electric-500 to-electric-600 rounded-lg flex items-center justify-center electric-glow">
          ...
          <div className="p-4 border-t border-electric-200/30 dark:border-electric-700/30 space-y-2">
            <Link href="/">
              <div className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-navy-300 hover:text-white hover:bg-navy-700/50 dark:hover:bg-navy-800/50 transition-all duration-200 cursor-pointer morphing-button">
                <BarChart3 className="w-5 h-5" />
                Exit to App
              </div>
            </Link>
