...
export default function MapView({ markers = [], routes = [], center = DEFAULT_MAP_SETTINGS.center as [
    number,
    number
], zoom = DEFAULT_MAP_SETTINGS.zoom, onMarkerClick, }: MapViewProps) {
    ...
    return (<section className="relative w-full h-full overflow-hidden map-container" style={{ height: '100%', position: 'relative' }}>
      <div className="w-full h-full bg-[hsl(var(--muted))]" style={{ height: '100%', position: 'relative' }}>
        ...
        <div className="absolute top-4 right-4 flex flex-col space-y-2">
          <Button variant="secondary" size="icon" className="bg-white hover:bg-white dark:bg-[hsl(var(--card))] dark:hover:bg-[hsl(var(--card))] shadow-md rounded-full" onClick={handleZoomIn}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clipRule="evenodd"/>
            </svg>
          </Button>
          <Button variant="secondary" size="icon" className="bg-white hover:bg-white dark:bg-[hsl(var(--card))] dark:hover:bg-[hsl(var(--card))] shadow-md rounded-full" onClick={handleZoomOut}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M5 10a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1z" clipRule="evenodd"/>
            </svg>
          </Button>
          <Button variant="secondary" size="icon" className="bg-white hover:bg-white dark:bg-[hsl(var(--card))] dark:hover:bg-[hsl(var(--card))] shadow-md rounded-full" onClick={handleLocate}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        {/* Map Footer Info */}
        {markers.length > 0 && (<div className="absolute bottom-4 left-4 right-4 bg-white dark:bg-[hsl(var(--card))] bg-opacity-90 dark:bg-opacity-90 p-3 rounded-lg shadow-lg">
        ...
        <div className="absolute bottom-20 right-4 md:hidden">
          <Button className="bg-[hsl(var(--primary))] text-white p-4 rounded-full shadow-lg" size="icon">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
