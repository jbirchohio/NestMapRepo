...
export function FlightResults({ flights, selectedFlight, onSelectFlight, isSearching, isReturnFlight = false, }: FlightResultsProps) {
    if (isSearching) {
    ...
    return (<div className="space-y-4">
      ...
      <div className="space-y-4">
        {flights.map((flight) => (<div key={flight.id} className={`border rounded-lg p-4 transition-colors ${selectedFlight?.id === flight.id
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <Button variant={selectedFlight?.id === flight.id ? 'default' : 'outline'} onClick={() => onSelectFlight(flight)} className="whitespace-nowrap">
