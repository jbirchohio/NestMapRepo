...
export default function Header({ trip, onOpenShare, onToggleSidebar, onRenameTrip, onDuplicateTrip, onExportPDF, onDeleteTrip }: HeaderProps) {
    const [, setLocation] = useLocation();
    const { toast } = useToast();
    return (<header className="bg-white dark:bg-[hsl(var(--card))] shadow-sm z-10">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
          <Button id="toggleSidebar" variant="ghost" size="icon" className="md:hidden text-[hsl(var(--primary))]" aria-label="Toggle Sidebar" onClick={onToggleSidebar}>
          ...
          {trip && (<>
              <Button variant="ghost" className="hidden md:flex items-center text-[hsl(var(--primary))] hover:text-[hsl(var(--primary))]" onClick={onOpenShare}>
