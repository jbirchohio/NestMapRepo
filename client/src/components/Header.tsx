      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          >
            ...
            <h1 className="ml-2 text-xl font-semibold">Remvana</h1>
          </div>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem onClick={onToggleCollaborative}>
                    <Users className={`h-4 w-4 mr-2 ${trip?.collaborativeMode ? 'text-green-600' : 'text-gray-400'}`} />
                    <span>
                      {trip?.collaborativeMode ? 'Disable' : 'Enable'} Collaborative Mode
                      {trip?.collaborativeMode && <span className="ml-2 text-xs text-green-600">(ON)</span>}
                    </span>
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
