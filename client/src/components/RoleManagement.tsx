        ...
        <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select value={inviteRole} onValueChange={setInviteRole}>
                    ...
                    <SelectContent>
                      {Object.entries(TRIP_ROLES).map(([role, config]) => (
              ...
              {isLoading ? (
                ...
                <div className="rounded-md border">
                  <Table>
                    ...
                    <TableBody>
                      {collaborators.map((collaborator: TripCollaborator) => (
                        <TableRow key={collaborator.id}>
                          ...
                          <TableCell className="text-right">
                            <Button
                              ...
                              disabled={!canManageRoles || removeCollaboratorMutation.isPending}
                            >
                              Remove
                            </Button>
                          </TableCell>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {Object.entries(TRIP_ROLES).map(([role, config]) => (
                <div key={role} className="flex items-center justify-between p-3 rounded border">
                  <div>
