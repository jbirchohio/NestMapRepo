...
export default function OnboardingWizard({ onComplete }: OnboardingWizardProps) {
  ...
  const [wizardData, setWizardData] = useState({
    ...
    teamInvites: [] as { email: string; role: string; name: string }[],
    sampleTrip: {
        ...
        <Card className="bg-white/80 dark:bg-navy-800/80 backdrop-blur-sm border border-electric-300/20">
              ...
              {steps.map((step, index) => (
                <div key={step.id} className="flex flex-col items-center gap-1">
                  ...
                  <span className={`text-xs text-center ${
                    index === currentStep ? 'text-electric-600 font-medium' : 'text-navy-500'
                  }`}>
                    {step.title}
                  </span>
                </div>
          ...
          <CardContent>
                ...
                {currentStep === 0 && (
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <Textarea
                        id="description"
                        value={wizardData.company.description}
                        onChange={(e) => setWizardData(prev => ({
                          ...prev,
                          company: { ...prev.company, description: e.target.value }
                        }))}
                        placeholder="Brief description of your company and travel needs..."
                        rows={3}
                      />
                    </div>
                  </div>
                ...
                {currentStep === 1 && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      {wizardData.teamInvites.map((invite, index) => (
                        <Card key={index} className="p-4 bg-navy-50/50 dark:bg-navy-700/50">
                      ...
                      <Button
                        ...
                        className="w-full border-dashed border-electric-300 text-electric-600 hover:bg-electric-50"
                      >
                    ...
                    <Card className="p-4 bg-gradient-to-r from-electric-50 to-electric-100 dark:from-electric-900/20 dark:to-electric-800/20">
                      <div className="space-y-4">
                        <div>
                          ...
                          <Input
                            id="trip-title"
                            value={wizardData.sampleTrip.title}
                            onChange={(e) => setWizardData(prev => ({
                              ...prev,
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <Input
                              id="destination"
                              value={wizardData.sampleTrip.destination}
                              onChange={(e) => setWizardData(prev => ({
                                ...prev,
                          ...
                          <div>
                            ...
                            <Input
                              id="budget"
                              type="number"
                              value={wizardData.sampleTrip.budget}
                              onChange={(e) => setWizardData(prev => ({
                                ...prev,
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <Input
                              id="start-date"
                              type="date"
                              value={wizardData.sampleTrip.startDate}
                              onChange={(e) => setWizardData(prev => ({
                                ...prev,
                          ...
                          <div>
                            ...
                            <Input
                              id="end-date"
                              type="date"
                              value={wizardData.sampleTrip.endDate}
                              onChange={(e) => setWizardData(prev => ({
                                ...prev,
                ...
                {currentStep === 3 && (
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <Card className={`p-4 cursor-pointer transition-all ${
                        wizardData.billing.plan === 'enterprise' 
                          ? 'ring-2 ring-electric-500 bg-electric-50/50 dark:bg-electric-900/20' 
                          : 'hover:bg-navy-50/50 dark:hover:bg-navy-700/50'
                      }`} onClick={() => setWizardData(prev => ({ ...prev, billing: { ...prev.billing, plan: 'enterprise' } }))}>
                        <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        type="checkbox"
                        id="skip-billing"
                        checked={wizardData.billing.skipForNow}
                        onChange={(e) => setWizardData(prev => ({
                          ...prev,
            ...
            <div className="flex justify-between">
              ...
              <Button
                onClick={handleNext}
                disabled={!canProceed() || companyMutation.isPending || inviteMutation.isPending || tripMutation.isPending}
