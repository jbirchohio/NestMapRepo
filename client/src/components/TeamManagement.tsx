    ...
    return (<div className="min-h-screen bg-soft-100 dark:bg-navy-900 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button onClick={() => setShowInviteForm(!showInviteForm)} className="flex items-center gap-2 bg-electric-500 hover:bg-electric-600 text-white">
        ...
        {/* Invite Form */}
        {showInviteForm && (<Card className="bg-white/80 dark:bg-navy-800/80 backdrop-blur-sm border border-electric-300/20">
            <CardHeader>
          ...
          <CardContent>
            <form onSubmit={form.handleSubmit(onInviteSubmit)} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Switch checked={currentPermissions.canViewAllTrips} onCheckedChange={(checked) => form.setValue("permissions.canViewAllTrips", checked)}/>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch checked={currentPermissions.canCreateTrips} onCheckedChange={(checked) => form.setValue("permissions.canCreateTrips", checked)}/>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch checked={currentPermissions.canInviteMembers} onCheckedChange={(checked) => form.setValue("permissions.canInviteMembers", checked)}/>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch checked={currentPermissions.canManageBudgets} onCheckedChange={(checked) => form.setValue("permissions.canManageBudgets", checked)}/>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch checked={currentPermissions.canExportData} onCheckedChange={(checked) => form.setValue("permissions.canExportData", checked)}/>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch checked={currentPermissions.canAccessAnalytics} onCheckedChange={(checked) => form.setValue("permissions.canAccessAnalytics", checked)}/>
                      </div>
                    </div>
                  </div>
                </>)}
              ...
              <div className="flex justify-end gap-3">
                <Button type="button" variant="outline" onClick={() => setShowInviteForm(false)} className="border-electric-300/30 text-navy-600 dark:text-navy-300 hover:bg-electric-50 dark:hover:bg-electric-900/20">
                  Cancel
                </Button>
        ...
        {showMemberDetails && selectedMember && (<Card className="mb-6 bg-white/80 dark:bg-navy-800/80 backdrop-blur-sm border border-electric-300/20">
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="flex items-center gap-2 text-navy-900 dark:text-white">
      ...
      {showEditPermissions && selectedMember && (<Card className="mb-6">
          <CardHeader>
            <div className="flex items-center justify-between">
          ...
          <CardContent>
            <div className="space-y-6">
            ...
            ].map((permission) => (<div key={permission.key} className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label className="text-sm">{permission.label}</Label>
                        <p className="text-xs text-muted-foreground">{permission.desc}</p>
                      </div>
                      <Switch defaultChecked={selectedMember.role === 'admin'} className="data-[state=checked]:bg-blue-600 data-[state=unchecked]:bg-gray-200 dark:data-[state=unchecked]:bg-gray-700 border border-gray-300 data-[state=checked]:border-blue-600" style={{
              ...
              <div className="flex justify-end gap-3">
                <Button variant="outline" onClick={() => setShowEditPermissions(false)} className="border-electric-300/30 text-navy-600 dark:text-navy-300 hover:bg-electric-50 dark:hover:bg-electric-900/20">
                  Cancel
                </Button>
                <Button onClick={() => {
                toast({
        ...
        <Card className="bg-white/80 dark:bg-navy-800/80 backdrop-blur-sm border border-electric-300/20">
          ...
          <CardContent>
            <div className="space-y-4">
            {isLoadingMembers ? (<div className="text-center py-8">
                <p className="text-navy-500 dark:text-navy-400">Loading team members...</p>
              </div>) : teamMembers && teamMembers.length > 0 ? (teamMembers.map((member: TeamMember) => (<div key={member.id} className="flex items-center justify-between p-4 border border-electric-300/20 rounded-lg bg-white/50 dark:bg-navy-900/50 backdrop-blur-sm">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex gap-1">
                      <Button variant="outline" size="sm" onClick={() => handleViewMember(member)} title="View member details" className="border-electric-300/30 text-navy-600 dark:text-navy-300 hover:bg-electric-50 dark:hover:bg-electric-900/20">
                        <Eye className="h-4 w-4"/>
                      </Button>
                      <Button variant="outline" size="sm" onClick={() => handleEditMember(member)} title="Edit member permissions" className="border-electric-300/30 text-navy-600 dark:text-navy-300 hover:bg-electric-50 dark:hover:bg-electric-900/20">
                        <Edit3 className="h-4 w-4"/>
                      </Button>
                      <Button variant="outline" size="sm" className="border-red-300/30 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20" onClick={() => handleRemoveMember(member)} title="Remove member">
