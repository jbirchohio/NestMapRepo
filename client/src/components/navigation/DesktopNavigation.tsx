      ...
      <div className="flex items-center">
        ...
        {!isAuthenticated && (
          <div className="flex space-x-4">
            <button
              onClick={onSignIn}
              className="inline-flex items-center justify-center rounded-md border border-transparent bg-electric-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-electric-700 focus:outline-none focus:ring-2 focus:ring-electric-500 focus:ring-offset-2 transition-colors"
            >
              Sign In
            </button>
          </div>
