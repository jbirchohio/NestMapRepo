      ...
      <div className="bg-white rounded-lg w-full max-w-md p-6 shadow-xl">
        ...
        <div className="space-y-4">
          <div>
            ...
            <TripDatePicker startDate={selectedDate} endDate={selectedDate} selectedDate={selectedDate.toISOString().split('T')[0]} onDateSelect={(sel: string) => {
        ...
        } : { date: selectedDate } as any} tripId={tripId.toString()} onSubmit={handleSubmit}/>
        </div>
      </div>
    </div>);
}
