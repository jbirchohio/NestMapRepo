...
export default function AnalyticsDashboard() {
    ...
    if (isLoading) {
        return (<div className="min-h-screen bg-gradient-to-br from-white via-electric-50/30 to-electric-100/50 dark:from-dark-900 dark:via-electric-900/10 dark:to-electric-800/20 p-6 space-y-6">
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-navy-50 via-electric-50/30 to-electric-100/50 dark:from-navy-900 dark:via-navy-800 dark:to-electric-900/20 p-6 space-y-8">
      {/* Header */}
      <div className="flex items-center justify-between">
        ...
        <Button onClick={handleExportCSV} className="flex items-center gap-2 bg-electric-500 hover:bg-electric-600 text-white">
          ...
          <CardContent>
            <div className="space-y-3">
              {analytics.destinations.slice(0, 8).map((destination: { city: string; country: string; tripCount: number; percentage: number }, index: number) => (<div key={`${destination.city}-${destination.country}`} className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Progress value={destination.percentage} className="w-20"/>
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            ...
            day: 'numeric'
              ...
              <Line type="monotone" dataKey="trips" stroke="#8884d8" strokeWidth={3} dot={{ fill: '#8884d8', strokeWidth: 2, r: 4 }}/>
            </LineChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Progress value={Math.round((analytics.userFunnel.usersWithTrips / analytics.userFunnel.totalUsers) * 100)} className="w-32"/>
                <span className="text-lg font-bold min-w-[3rem]">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Progress value={Math.round((analytics.userFunnel.usersWithActivities / analytics.userFunnel.totalUsers) * 100)} className="w-32"/>
                <span className="text-lg font-bold min-w-[3rem]">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Progress value={Math.round((analytics.userFunnel.usersWithCompletedTrips / analytics.userFunnel.totalUsers) * 100)} className="w-32"/>
                <span className="text-lg font-bold min-w-[3rem]">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Progress value={Math.round((analytics.userFunnel.usersWithExports / analytics.userFunnel.totalUsers) * 100)} className="w-32"/>
                <span className="text-lg font-bold min-w-[3rem]">
