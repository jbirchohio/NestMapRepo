...
function PricingInsights({ data }: {
    ...
    return (<div className="space-y-4">
      ...
      {predictedPrices && predictedPrices.length > 0 && (<Card>
          <CardHeader>
...
function CrowdInsights({ data, activities }: {
    ...
    return (<div className="space-y-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              {peakHours?.map((hour: string, index: number) => (<div key={index} className="flex items-center gap-2 p-2 bg-red-50 dark:bg-red-900/20 rounded">
      ...
      {alternativeOptions && alternativeOptions.length > 0 && (<Card>
          <CardHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {weatherForecast?.map((day: SharedDayType, index: number) => (<Card key={index}>
            <CardContent className="pt-6">
              ...
              {day.precipitation > 0 && (<div className="text-sm text-blue-600 mt-1">{day.precipitation}mm rain</div>)}
              <div className="mt-2 text-xs text-gray-500">{day.recommendation}</div>
            </CardContent>
          </Card>))}
      </div>

      {indoorAlternatives && indoorAlternatives.length > 0 && (<Card>
          <CardHeader>
    ...
    return (<div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <Progress value={((budgetOptimization?.savings || 0) / (budgetOptimization?.originalCost || 1)) * 100} className="mt-2"/>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Progress value={((timeOptimization?.timeSaved || 0) / (timeOptimization?.originalDuration || 1)) * 100} className="mt-2"/>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Progress value={(experienceOptimization?.satisfactionScore || 0) * 10} className="mt-2"/>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              {budgetOptimization?.recommendations?.map((rec: string, index: number) => (<div key={index} className="flex items-start gap-2 p-2 bg-green-50 dark:bg-green-900/20 rounded">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              {experienceOptimization?.personalizedSuggestions?.map((suggestion: string, index: number) => (<div key={index} className="flex items-start gap-2 p-2 bg-electric-50 dark:bg-electric-900/20 rounded">
