...
export function useRolePermissions() {
    ...
    return {
        ...
        hasAnyPermission: (permissionList: (keyof RolePermissions)[]) => permissionList.some(permission => rolePermissions[permission])
    };
}
/**
...
export function RoleGate({ children, requiredPermissions = [], requireAll = false, fallback = null }: RoleGateProps) {
