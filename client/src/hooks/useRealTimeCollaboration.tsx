...
export function useRealTimeCollaboration({ tripId, organizationId, userId }: UseRealTimeCollaborationProps) {
    ...
    const handleWebSocketMessage = (data: SharedDataType) => {
        switch (data.type) {
            ...
            case 'presence_update':
                setCollaborators(prev => prev.map(c => c.userId === data.userId
