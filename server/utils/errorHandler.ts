 ...
 */
export function createErrorResponse(code: keyof typeof ErrorCodes, message: string, details?: any, requestId?: string): StandardErrorResponse {
    return {
        success: false,
        error: {
...
export const CommonErrors = {
    ...
    validation: (message = 'Invalid input data', details?: any) => createErrorResponse('VALIDATION_ERROR', message, details),
