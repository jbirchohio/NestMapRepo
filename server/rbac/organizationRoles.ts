 ...
 */
export function hasOrganizationPermission(userRole: OrganizationRole, permission: keyof OrganizationPermissions, customPermissions?: Partial<OrganizationPermissions>): boolean {
 ...
 */
export function getOrganizationPermissions(userRole: OrganizationRole, customPermissions?: Partial<OrganizationPermissions>): OrganizationPermissions {
 ...
 */
export function canAccessTrip(userRole: OrganizationRole, isOwnTrip: boolean, isCollaborator: boolean, action: 'view' | 'edit' | 'delete', customPermissions?: Partial<OrganizationPermissions>): boolean {
    ...
    switch (action) {
        ...
        case 'edit':
            if (isOwnTrip && permissions.editOwnTrips)
                return true;
            if (permissions.editAllTrips)
                return true;
            return isCollaborator; // Trip collaborators can edit
        case 'delete':
            if (isOwnTrip && permissions.deleteOwnTrips)
                return true;
