...
// Remove the shared import - we'll define types locally or import from a proper package
// import { ApiResponse, PaginatedApiResponse } from '../../../shared/src/types/api';
...
export const extendResponse = (
  ...
  res.paginate = function <T = any>(
    ...
    return ResponseHandler.paginate<T>(
      this,
      data,
      total,
      page,
