 ...
 */
export const formatSuccessResponse = <T>(data: T, message?: string, meta?: Record<string, unknown>): ApiSuccessResponse<T> => ({
    success: true,
    data,
    ...(message && { message }),
    ...(meta && { meta }),
 ...
 */
export const formatErrorResponse = (message: string, details?: Record<string, unknown>): ApiErrorResponse => ({
    success: false,
    message,
    ...(details && { details }),
});
...
export class ResponseFormatter {
     ...
     */
    static success<T>(res: Response, data: T, message?: string, meta?: Record<string, unknown>, statusCode = 200): Response {
     ...
     */
    static error(res: Response, message: string, details?: Record<string, unknown>, statusCode = 400): Response {
