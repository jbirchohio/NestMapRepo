import type { Injectable, Inject, Logger } from '@nestjs/common';
import type { BookingRepository } from '../repositories/booking/booking.repository.interface.js';
import type { Booking } from '../../../db/bookingSchema.js';
import type { BookingConfirmationDetails } from '../interfaces/booking.interfaces.js';
/**
