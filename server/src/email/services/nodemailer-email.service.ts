...
import type { EmailService, EmailOptions, PasswordResetEmailOptions, PasswordResetConfirmationOptions, PaymentReceiptEmailOptions } from '../interfaces/email.service.interface.js';
...
export class NodemailerEmailService implements EmailService {
    ...
    constructor(private readonly configService: ConfigService, private readonly errorService: ErrorService) {
    ...
    async sendPasswordResetEmail(email: string, options: PasswordResetEmailOptions): Promise<void> {
    ...
    async sendPasswordResetConfirmationEmail(email: string, options: PasswordResetConfirmationOptions): Promise<void> {
    ...
    async sendPaymentReceiptEmail(email: string, options: PaymentReceiptEmailOptions): Promise<void> {
