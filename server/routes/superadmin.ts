...
const createSuperadminRoutes = () => {
    ...
    type Middleware = (req: Request, res: Response, next: NextFunction) => void | Response | Promise<void | Response>;
    ...
    router.use(applyMiddleware((req, res, next) => requireSuperadmin(req as AuthenticatedRequest, res, next)));
