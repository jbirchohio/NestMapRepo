...
export const createOrganization = async (req: Request, res: Response) => {
    try {
        ...
        // Log the action
        if (userId) {
            await logSuperadminAction(parseInt(userId, 10), 'CREATE_ORGANIZATION', 'organization', newOrg.id, { name, plan });
        }
...
export const updateOrganization = async (req: Request, res: Response) => {
    try {
        ...
        // Log the action
        if (userId) {
            await logSuperadminAction(parseInt(userId, 10), 'UPDATE_ORGANIZATION', 'organization', orgId, updates);
        }
...
export const deleteOrganization = async (req: Request, res: Response) => {
    try {
        ...
        // Log the action
        if (userId) {
            await logSuperadminAction(parseInt(userId, 10), 'DELETE_ORGANIZATION', 'organization', orgId, { name: org.name });
        }
